...
def run_cycle(
    ...
    *,
    ...
    max_cross_product_specs: int = 12,
    max_nas_specs: int = 6,
    max_name_free_specs: int = 12,
    max_data_route_specs: int = 0,
    ...
    specs = enumerate_cycle_specs(
        ...
        max_cross_product_specs=max_cross_product_specs,
        max_nas_specs=max_nas_specs,
        max_name_free_specs=max_name_free_specs,
        max_data_route_specs=max_data_route_specs,
        include_data_routes=include_data_routes,
