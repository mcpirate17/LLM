...
_PROGRAM_RESULTS_NEW_COLUMNS = {
    ...
    "induction_probe_pool_size": "INTEGER",
    "binding_auc": "REAL",
    "binding_auc_curriculum": "REAL",
    "binding_distance_accuracies_json": "TEXT",
    "binding_distance_accuracies_curriculum_json": "TEXT",
    "binding_probe_eval_examples": "INTEGER",
    "binding_probe_distances_json": "TEXT",
    "binding_probe_elapsed_ms": "REAL",
    "binding_probe_curriculum_steps": "INTEGER",
    "binding_probe_curriculum_elapsed_ms": "REAL",
    "binding_probe_curriculum_protocol_version": "TEXT",
    ...
    "induction_v2_investigation_steps_trained": "INTEGER",
    "induction_v2_investigation_status": "TEXT",
    "induction_v2_investigation_elapsed_ms": "REAL",
    ...
    "binding_v2_investigation_distance_accuracies_json": "TEXT",
    "binding_v2_investigation_train_steps": "INTEGER",
    "binding_v2_investigation_status": "TEXT",
    "binding_v2_investigation_elapsed_ms": "REAL",
    "binding_v2_investigation_protocol_version": "TEXT",
    # Champion-tier induction and small-AR probes.
