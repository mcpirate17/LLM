...
def test_pareto_logic(tmp_path):
    ...
    # Accurate but huge
    r1 = nb.record_program_result(exp_id, "fp1", "{}", stage0_passed=1, stage1_passed=1, loss_ratio=0.2, param_count=1000)
    # Accurate and small
    r2 = nb.record_program_result(exp_id, "fp2", "{}", stage0_passed=1, stage1_passed=1, loss_ratio=0.2, param_count=100)
    # Bad but tiny
    r3 = nb.record_program_result(exp_id, "fp3", "{}", stage0_passed=1, stage1_passed=1, loss_ratio=0.8, param_count=10)
