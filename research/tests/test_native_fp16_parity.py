...
def _assert_close_f16(actual_f16: np.ndarray, expected_f32: np.ndarray,
                       label: str = ""):
...
class TestBinaryF16:
    ...
    def _call_f32(self, name):
        ...
        fn.restype = None
        fn(self.a_f32.ctypes.data, self.b_f32.ctypes.data,
           self.y_f32.ctypes.data, self.n)

    def _call_f16(self, name):
        fn = getattr(self.lib, f'aria_{name}_f16')
        fn.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int64]
        fn.restype = None
        fn(self.a_f16.ctypes.data, self.b_f16.ctypes.data,
           self.y_f16.ctypes.data, self.n)
...
class TestMatmulF16:
    ...
    def test_matmul_f16(self, M, K, N):
        ...
        fn32.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
        ...
        fn16.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
                         ctypes.c_int64, ctypes.c_int64, ctypes.c_int64]
        fn16.restype = None
        ...
        np.testing.assert_allclose(
            actual, C_f32, atol=5e-2, rtol=1e-2,
            err_msg=f"matmul_f16 {M}x{K}x{N}"
        )
...
class TestSoftmaxF16:
    ...
    def test_softmax_f16(self, batch, dim):
        ...
        fn32.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int64, ctypes.c_int64]
        fn32.restype = None
        fn32(x_f32.ctypes.data, y_f32.ctypes.data, batch, dim)

        fn16 = self.lib.aria_softmax_f16
        fn16.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int64, ctypes.c_int64]
        fn16.restype = None
...
class TestRMSNormF16:
    ...
    def test_rmsnorm_f16(self, batch, dim):
        ...
        fn32.restype = None
        fn32(x_f32.ctypes.data, w_f32.ctypes.data, y_f32.ctypes.data,
             batch, dim, eps)
        ...
        fn16.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
                         ctypes.c_int64, ctypes.c_int64, ctypes.c_float]
        fn16.restype = None
        fn16(x_f16.ctypes.data, w_f16.ctypes.data, y_f16.ctypes.data,
             batch, dim, eps)
