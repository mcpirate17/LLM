...
class TestReluBackward:
    ...
    def test_relu_backward(self):
        ...
        fn.restype = None
        fn(
            self.grad_out.ctypes.data,
            self.input.ctypes.data,
            self.grad_in.ctypes.data,
            self.n,
        )
...
class TestGeluBackward:
    ...
    def test_gelu_backward(self):
        ...
        _assert_close(
            self.grad_in, expected, "gelu_backward", atol=ATOL_GELU, rtol=RTOL_GELU
        )
...
class TestAddBackward:
    ...
    def test_add_backward(self):
        ...
        fn(
            self.grad_out.ctypes.data,
            self.grad_a.ctypes.data,
            self.grad_b.ctypes.data,
            self.n,
        )
...
class TestMatmulBackward:
    ...
    @pytest.mark.parametrize(
        "M,K,N", [(2, 3, 2), (16, 32, 16), (64, 64, 64), (1, 128, 1), (4, 8, 4)]
    )
...
class TestNumericalGradientCheck:
    ...
    def test_matmul_numerical(self):
        ...
        _assert_close(
            grad_A, num_grad_A, "matmul grad_A numerical", atol=1e-3, rtol=1e-3
        )
