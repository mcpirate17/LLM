...
def main() -> None:
    ...
    json_path = REPORTS_DIR / "nano_ar_inv_midtier_3seed.json"
    md_path = REPORTS_DIR / "nano_ar_inv_midtier_3seed.md"
    json_path.write_text(json.dumps(out, indent=2, default=str))
    rows_sorted = sorted(out_rows, key=lambda r: r["in_pair_mu"], reverse=True)
    lines = [
        "# nano-AR-INV mid-tier (composite 100-300) 3-seed sweep",
        "",
