    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        for t in range(seq_len):
            ...
            if (t + 1) % self.pool_period == 0:
                ...
                pooled_token = token # Fallback for non-update steps (simplification for testing)
...
def run_eval():
    ...
    with open("research/reports/universal_recall_results.json", "w") as f: json.dump(results, f, indent=2)
