...
TEMPLATES: Dict[str, TemplateFn] = {
    ...
    "attn_linear_normalized_matmul_control": tpl_attn_linear_normalized_matmul_control,
    "attn_linear_no_matmul_ffn": tpl_attn_linear_no_matmul_ffn,
    "attn_linear_matmul_sparse_tail": tpl_attn_linear_matmul_sparse_tail,
    "attn_linear_matmul_router_sidecar": tpl_attn_linear_matmul_router_sidecar,
...
DEFAULT_TEMPLATE_WEIGHTS: Dict[str, float] = {
    ...
    "attn_softmax_normalized_matmul": 2.0,
    "attn_linear_normalized_matmul_control": 2.0,
    "attn_linear_no_matmul_ffn": 2.0,
    "attn_linear_matmul_sparse_tail": 2.0,
    "attn_linear_matmul_router_sidecar": 2.0,
