...
128 graphs improved from about `3.01 ms` to `1.09 ms` median; warmed
`batch_generate` improved from `55.50 ms` to `48.59 ms` at 128 graphs and from
`260.42 ms` to `230.02 ms` at 512 graphs. Focused native/batch tests pass.
