...
Not complete yet:
- `research/synthesis/graph_validator.py::validate_dim_flow()` is not wired to
  the packed result yet.
- Native runtime has not been rebuilt after the ABI addition.
- Parity/perf tests have not been run for this new packed boundary.
