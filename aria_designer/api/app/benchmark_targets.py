...
_TARGET_SPECS: List[Dict[str, Any]] = [
    {
        ...
        "category": "size",
        "unit": "params",
        "measurement": "Auto-measured in Deep Run sandbox stage (param_count).",
        "direction": "lte",
    ...
    },
    {
        ...
        "category": "flops",
        "unit": "flops",
        "measurement": "Auto-measured in Deep Run profiling stage (total_flops_per_token).",
        "direction": "lte",
    ...
    },
    {
        ...
        "category": "speed",
        "unit": "ms",
        "measurement": "Auto-measured in Deep Run sandbox stage (forward_ms).",
        "direction": "lte",
        "target": 50.0,
    ...
    },
    {
        ...
        "category": "quality",
        "unit": "score",
        "measurement": "Auto-measured in Deep Run sandbox stage (stability_score).",
        "direction": "gte",
        "target": 0.95,
    ...
    },
    {
        ...
        "category": "quality",
        "unit": "score",
        "measurement": "Auto-measured in Deep Run compression stage (efficiency_score).",
        "direction": "gte",
        "target": 0.75,
    ...
    },
    {
        ...
        "category": "quality",
        "unit": "score",
        "measurement": "Auto-measured in Deep Run novelty stage (overall_novelty).",
        "direction": "gte",
        "target": 0.70,
    ...
    },
    {
        ...
        "category": "task",
        "unit": "percent",
        "measurement": "Requires external benchmark harness result via budget.benchmark_observed.mmlu_5shot.",
        "direction": "gte",
        "target": 66.6,
    ...
    },
    {
        ...
        "category": "task",
        "unit": "percent",
        "measurement": "Requires external benchmark harness result via budget.benchmark_observed.humaneval_0shot.",
        "direction": "gte",
        "target": 62.2,
    ...
    },
    {
        ...
        "category": "task",
        "unit": "percent",
        "measurement": "Requires external benchmark harness result via budget.benchmark_observed.gsm8k_8shot_cot.",
        "direction": "gte",
        "target": 79.6,
        "source": "Llama 3 8B instruct model card",
    },
    {
        ...
        "category": "task",
        "unit": "percent",
        "measurement": "Requires external benchmark harness result via budget.benchmark_observed.arc_challenge_25shot.",
        "direction": "gte",
        "target": 78.6,
        "source": "Llama 3 8B base pretrained model card",
    },
    {
        ...
        "category": "recall",
        "unit": "percent",
        "measurement": "Requires synthetic recall-suite result via budget.benchmark_observed.induction_recall_accuracy.",
        "direction": "gte",
        "target": 99.8,
    ...
    },
    {
        ...
        "category": "speed",
        "unit": "x",
        "measurement": "Requires side-by-side throughput benchmark via budget.benchmark_observed.throughput_vs_transformer.",
        "direction": "gte",
        "target": 5.0,
